  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.20,
        yanchor: 'center',
        text: 'The bar chart displays the top 10 bacterial species <br>found in belly button samples',
        showarrow: false
      }]
    ...
    // Bubble chart for deliverable 2
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "The gauge chart displays belly button weekly washing frequency",
        showarrow: false
      }]
    };
